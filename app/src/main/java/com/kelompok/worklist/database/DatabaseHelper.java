package com.kelompok.worklist.database;
...
import com.kelompok.worklist.utils.Constant;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        cv.put(Constant.CATEGORY_NAME, "Sistem Informasi Sumberdaya");
        db.insert(Constant.TABLE_CATEGORY, null, cv);

        ContentValues cv1 = new ContentValues();
        cv1.put(Constant.CATEGORY_NAME, "Desain Interface");
        db.insert(Constant.TABLE_CATEGORY, null, cv1);

        ContentValues cv2 = new ContentValues();
        cv2.put(Constant.CATEGORY_NAME, "Pemrogaman Web");
        db.insert(Constant.TABLE_CATEGORY, null, cv2);

        ContentValues cv3 = new ContentValues();
        cv3.put(Constant.CATEGORY_NAME, "Aplikasi Perangkat Bergerak");
        db.insert(Constant.TABLE_CATEGORY, null, cv3);

        ContentValues cv4 = new ContentValues();
        cv4.put(Constant.CATEGORY_NAME, "Perancangan Sistem Informasi");
        db.insert(Constant.TABLE_CATEGORY, null, cv4);

        ContentValues cv5 = new ContentValues();
        cv5.put(Constant.CATEGORY_NAME, "Sofware Berbasis Layanan");
        db.insert(Constant.TABLE_CATEGORY, null, cv5);

        ContentValues cv6 = new ContentValues();
        cv6.put(Constant.CATEGORY_NAME, "SMBD");
        db.insert(Constant.TABLE_CATEGORY, null, cv6);

        ContentValues cv7 = new ContentValues();
        cv7.put(Constant.CATEGORY_NAME, "Perancangan Berbasis Objek");
        db.insert(Constant.TABLE_CATEGORY, null, cv7);
